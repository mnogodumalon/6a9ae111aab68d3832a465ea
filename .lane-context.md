...
- `personalnummer` · text · Personalnummer · maxLength 4000
- `abteilung` · lookup · Abteilung · options: strassenbau | gruenpflege | hochbau | elektrik | fuhrpark | reinigung | verwaltung | winterdienst
- `mobil` · tel · Mobil
- `aktiv` · bool · Aktiv

### `werkzeuge` — Werkzeuge (type `Werkzeuge`, one record: `WerkzeugeEntry`)
Display fields: `bezeichnung`
- `bezeichnung` · text · Bezeichnung · required! · maxLength 4000
- `inventarnummer` · text · Inventarnummer · required! · maxLength 4000
- `status` · lookup · Status · required! · options: verfuegbar | verliehen | defekt | in_wartung
- `bestand` · number · Bestand
- `standort` · geo · Standort
- `anschaffungspreis` · number · Anschaffungspreis (Euro) · currency
- `handbuch` · url · Handbuch
- `kategorien` · multilookup · Kategorien · options: elektrowerkzeug | handwerkzeug | messgeraet | sicherheitsausruestung
- `ersatz_fuer` · record · Ersatz für · → `werkzeuge`
Input shapes: choice `status` (ChoiceGroup); stock `bestand` (BudgetTracker)

### `ausleihen` — Ausleihen (type `Ausleihen`, one record: `AusleihenEntry`)
Display fields: `werkzeug`
- `werkzeug` · record · Werkzeug · required! · → `werkzeuge`
- `mitarbeiter` · record · Mitarbeiter · required! · → `mitarbeiter`
- `ausgabe` · datetime · Ausgabe · required!
- `rueckgabe_geplant` · date · Rückgabe geplant
- `rueckgabe_erfolgt` · datetime · Rückgabe erfolgt
- `zustand_bei_rueckgabe` · lookup · Zustand bei Rückgabe · options: einwandfrei | gebrauchsspuren | beschaedigt | verloren
Input shapes: choice `zustand_bei_rueckgabe` (ChoiceGroup)

### `wartungen` — Wartungen (type `Wartungen`, one record: `WartungenEntry`)
Display fields: `beschreibung`
- `datum` · date · Datum · required!
- `beschreibung` · textarea · Beschreibung
- `kosten` · number · Kosten (Euro) · currency
- `erledigt` · bool · Erledigt
- `werkzeug` · record · Werkzeug · required! · → `werkzeuge`

### `schaeden` — Schäden (type `Schaeden`, one record: `SchaedenEntry`)
Display fields: `beschreibung`
- `werkzeug` · record · Werkzeug · required! · → `werkzeuge`
- `gemeldet_am` · date · Gemeldet am · required!
- `beschreibung` · textarea · Beschreibung
- `foto` · file · Foto · read-only
