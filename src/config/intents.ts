...
// <custom:intent-imports>
import { IconHandStop, IconArrowBack, IconAlertTriangle } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausgeben', label: { de: 'Werkzeug ausgeben', en: 'Issue tool' }, icon: IconHandStop, description: 'Werkzeug an einen Mitarbeiter ausgeben — nur verfuegbare Geraete' },
  { path: '/intents/werkzeug-zurueckgeben', label: { de: 'Werkzeug zurueckgeben', en: 'Return tool' }, icon: IconArrowBack, description: 'Werkzeug zuruecknehmen, Zustand erfassen, ggf. Wartung ausloesen' },
  { path: '/intents/schaden-melden-intern', label: { de: 'Schaden melden', en: 'Report damage' }, icon: IconAlertTriangle, description: 'Schaden an einem Werkzeug melden und Wartungsauftrag anlegen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T08:43:22+00:00';
