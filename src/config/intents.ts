...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausgeben', label: { de: 'Werkzeug ausgeben', en: 'Issue tool' }, icon: IconArrowRight, description: 'Werkzeuge an einen Mitarbeiter ausgeben — nur verfügbare' },
  { path: '/intents/werkzeug-ruecknahme', label: { de: 'Rücknahme', en: 'Return tool' }, icon: IconArrowLeft, description: 'Werkzeug zurücknehmen, Zustand erfassen, ggf. Wartung anlegen' },
  { path: '/intents/schaden-melden-intern', label: { de: 'Schaden melden', en: 'Report damage' }, icon: IconAlertTriangle, description: 'Schaden an einem Werkzeug melden und Werkzeug als defekt markieren' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T12:55:22+00:00';
