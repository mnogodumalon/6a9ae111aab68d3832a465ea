...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/werkzeug-ruecknahme', label: { de: 'Ruecknahme', en: 'Return tool' }, icon: IconArrowBack, description: 'Werkzeug zuruecknehmen, Zustand erfassen und Status aktualisieren' },
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T10:57:26+00:00';
