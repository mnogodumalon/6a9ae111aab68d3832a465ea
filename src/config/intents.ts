...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausgeben', label: { de: 'Werkzeug ausgeben', en: 'Lend tool' }, icon: IconArrowRight, description: 'Werkzeug an einen Mitarbeiter ausgeben — nur verfuegbare' },
  { path: '/intents/werkzeug-zurueck', label: { de: 'Rückgabe erfassen', en: 'Return tool' }, icon: IconArrowLeft, description: 'Werkzeugrueckgabe mit Zustand erfassen — danach verfuegbar oder in Wartung' },
  { path: '/intents/schaden-melden-intern', label: { de: 'Schaden melden', en: 'Report damage' }, icon: IconAlertTriangle, description: 'Schaden an einem Werkzeug intern melden und Werkzeug auf Defekt setzen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-04T15:49:02+00:00';
