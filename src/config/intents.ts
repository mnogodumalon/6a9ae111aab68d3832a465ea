...
// <custom:intent-imports>
import { IconToolsKitchen2, IconArrowBack, IconAlertTriangle } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/werkzeug-ausgeben', label: { de: 'Werkzeug ausgeben', en: 'Issue tool' }, icon: IconToolsKitchen2, description: 'Werkzeuge an einen Mitarbeiter ausgeben — nur verfügbare' },
  { path: '/intents/werkzeug-zuruecknehmen', label: { de: 'Werkzeug zurücknehmen', en: 'Return tool' }, icon: IconArrowBack, description: 'Werkzeug zurücknehmen, Zustand erfassen, Status setzen' },
  { path: '/intents/schaden-melden-intern', label: { de: 'Schaden melden', en: 'Report damage' }, icon: IconAlertTriangle, description: 'Schaden an einem Werkzeug melden und Wartung anstoßen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T12:05:18+00:00';
