...
// <custom:intent-imports>
import { IconHandStop, IconArrowBackUp, IconAlertTriangle } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/werkzeug-zuruecknehmen', label: { de: 'Werkzeug zuruecknehmen', en: 'Return tool' }, icon: IconArrowBackUp, description: 'Werkzeug zuruecknehmen, Zustand erfassen, ggf. Wartung anlegen' },
  { path: '/intents/schaden-melden-intern', label: { de: 'Schaden melden', en: 'Report damage' }, icon: IconAlertTriangle, description: 'Schaden an einem Werkzeug melden und Wartung ausloesen' },
  // </custom:intents>
];
 ...
 */
export const INTENTS_PENDING_SINCE: string | null = '2026-09-07T09:53:27+00:00';
