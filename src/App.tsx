...
const IntentWerkzeugRuecknahmePage = lazy(() => import('@/pages/intents/WerkzeugRuecknahmePage'));
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/werkzeug-ruecknahme" element={<Suspense fallback={<DashboardSkeleton />}><IntentWerkzeugRuecknahmePage /></Suspense>} />
