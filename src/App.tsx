...
const IntentWerkzeugZurueckPage = lazy(() => import('@/pages/intents/WerkzeugZurueckPage'));
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/werkzeug-zurueck" element={<Suspense fallback={<DashboardSkeleton />}><IntentWerkzeugZurueckPage /></Suspense>} />
