...
const IntentWerkzeugZuruecknehmePage = lazy(() => import('@/pages/intents/WerkzeugZuruecknehmePage'));
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/werkzeug-zuruecknehmen" element={<Suspense fallback={<DashboardSkeleton />}><IntentWerkzeugZuruecknehmePage /></Suspense>} />
