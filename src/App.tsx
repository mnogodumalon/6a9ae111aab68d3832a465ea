...
const IntentWerkzeugZurueckgeben = lazy(() => import('@/pages/intents/WerkzeugZurueckgeben'));
        ...
        <HashRouter>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/werkzeug-zurueckgeben" element={<Suspense fallback={<DashboardSkeleton />}><IntentWerkzeugZurueckgeben /></Suspense>} />
