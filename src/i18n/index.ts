...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Bauhof Nord – Werkzeugverleih",
    "apps": {
      "mitarbeiter": {
        "name": "Mitarbeiter",
        "app_id": "6a9ae0d3ea58e12f04d058b8",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
      ...
      "werkzeuge": {
        "name": "Werkzeuge",
        "app_id": "6a9ae0d7cbcbecdbd87197b3",
        "fields": {
          ...
          "bestand": "Bestand",
          "standort": "Standort",
          "anschaffungspreis": "Anschaffungspreis (Euro)",
          "handbuch": "Handbuch",
          "kategorien": "Kategorien",
          "ersatz_fuer": "Ersatz für"
        },
        "lookups": {
          "status": {
      ...
      "ausleihen": {
        "name": "Ausleihen",
        "app_id": "6a9ae0d8b513fc8850fabef9",
        "fields": {
          "werkzeug": "Werkzeug",
          "mitarbeiter": "Mitarbeiter",
          "ausgabe": "Ausgabe",
          "rueckgabe_geplant": "Rückgabe geplant",
          "rueckgabe_erfolgt": "Rückgabe erfolgt",
          "zustand_bei_rueckgabe": "Zustand bei Rückgabe"
        },
        "lookups": {
      ...
      "wartungen": {
        "name": "Wartungen",
        "app_id": "6a9ae0d8ab5b3398be0528bd",
        "fields": {
          "datum": "Datum",
      ...
      "schaeden": {
        "name": "Schäden",
        "app_id": "6a9ae0d99c85cb9fa5a168ca",
        "fields": {
          "werkzeug": "Werkzeug",
          "gemeldet_am": "Gemeldet am",
          "beschreibung": "Beschreibung",
          "foto": "Foto"
        },
        "lookups": {}
  ...
  "en": {
    "appgroup": "Bauhof Nord – Tool Lending",
    "apps": {
      "mitarbeiter": {
        "name": "Employees",
        "app_id": "6a9ae0d3ea58e12f04d058b8",
        ...
        "lookups": {
          "abteilung": {
            ...
            "gruenpflege": "Grounds Maintenance",
      ...
      "werkzeuge": {
        ...
        "fields": {
          ...
          "bestand": "Stock",
          "standort": "Location",
          "anschaffungspreis": "Purchase Price (Euro)",
          "handbuch": "Manual",
          "kategorien": "Categories",
          "ersatz_fuer": "Replacement For"
        },
        "lookups": {
          "status": {
            "verfuegbar": "Available",
            "verliehen": "Checked Out",
            "defekt": "Defective",
      ...
      "ausleihen": {
        ...
        "fields": {
          ...
          "ausgabe": "Issue",
          "rueckgabe_geplant": "Return Planned",
          "rueckgabe_erfolgt": "Return Completed",
          "zustand_bei_rueckgabe": "Condition on Return"
        },
        "lookups": {
          "zustand_bei_rueckgabe": {
            "einwandfrei": "Flawless",
            "gebrauchsspuren": "Signs of Wear",
            "beschaedigt": "Damaged",
            "verloren": "Lost"
          }
        }
