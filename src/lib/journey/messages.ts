...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  werkzeuge: { bezeichnung: "Bitte die Bezeichnung eingeben.", inventarnummer: "Bitte die Inventarnummer eingeben.", status: "Bitte den Status wählen." },
  ausleihen: { werkzeug: "Bitte ein Werkzeug auswählen.", mitarbeiter: "Bitte einen Mitarbeiter auswählen.", ausgabe: "Bitte Datum und Uhrzeit der Ausgabe wählen." },
