...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  ausleihen: { werkzeug: "Bitte ein Werkzeug auswählen.", mitarbeiter: "Bitte einen Mitarbeiter auswählen.", ausgabe: "Bitte den Ausgabezeitpunkt angeben." },
  wartungen: { datum: "Bitte das Datum der Wartung angeben.", werkzeug: "Bitte das betroffene Werkzeug auswählen." },
  schaeden: { werkzeug: "Bitte das betroffene Werkzeug auswählen.", gemeldet_am: "Bitte das Meldedatum angeben." },
  // </custom:messages>
};
