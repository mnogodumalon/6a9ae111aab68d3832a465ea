...
export const REQUIRED_MESSAGES: { [E in EntityKey]?: Partial<Record<MessageFieldKey<E>, string>> } = {
  ...
  ausleihen: { werkzeug: "Bitte ein Werkzeug auswählen.", mitarbeiter: "Bitte einen Mitarbeiter auswählen.", ausgabe: "Bitte den Ausgabezeitpunkt wählen." },
  wartungen: { datum: "Bitte das Wartungsdatum wählen.", werkzeug: "Bitte das Werkzeug auswählen." },
  schaeden: { werkzeug: "Bitte das betroffene Werkzeug auswählen.", gemeldet_am: "Bitte das Datum des Schadens angeben." },
  // </custom:messages>
};
